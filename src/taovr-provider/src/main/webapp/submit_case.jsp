...
<body>
	<div id="main-content" class="clearfix" data-page="projectcenter"  sub-page="submit_case">
		<div id="breadcrumbs">
			<ul class="breadcrumb">
		...
		<div id="page-content" class="clearfix">
			...
			<div class="row-fluid" style="margin-top: -20px;">
					...
					<div class="span12">
						<div class="form-inline bord1dd form-add1">
							...
							<div class="form-group overhidden">
								<label class="mar-t-15">任务周期</label> <input style="width:210px" id="project_cycle"
									type="text" class="form-control  mar-t-15 wid155" 
									placeholder=""> 
								<select id="cycle_unit_name" style="width:100px" class="form-control mar-t-15 wid155" id="form-field-select-1">
				...
				<div class="tc mar-t-20">
					<button id="tj_btn" type="button" class="btn btn-submit" data-toggle="button"><i class=" icon-ok mr10"></i>案例提交 </button>
...
$(document).ready(function(){
	...
	$("#tj_btn").click(function(){
		...
		xco.setIntegerValue("case_audit_type",getCaseAuditType(2,2));//顾问新增案例
...
function getInsertProject(data){
	if(data.getCode()!=0){
		...
		jAlert("提交成功，工作人员会在2个工作日内完成审核工作。","提示",function(r){
			window.location.href="mycase.jsp";
		});		
	}
}

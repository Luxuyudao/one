...
<script type="text/javascript">
	...
	function selectOne(){
			var role = new XCO();
			role.setIntegerValue("id",getURLparam("id"));
			var options ={
			url:"/tvr-system/queryprojecttagById.xco",
			data:role,
			success: function(data){
				if (data.getCode() != 0) {
					...
					$("input[name=form-field-radio][value="+state+"]").attr("checked",true);
				}
			}
		};
	...
	$(function(){
		$("#ok").click(function(){
			...
			var options ={
					url:"/tvr-system/updateprojecttag.xco",
					data:data,
					success: function(data){
						if(data.getCode() != 0) {
							alert('doCallBack error:\n' + data);

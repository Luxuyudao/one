...
<body>
		...
		<div id="page-content" class="clearfix">
			<div class="row-fluid">
				...
				<div class="tc mar-t-20">
					<button id="close" type="button" class="btn btn-submit"
						data-toggle="button">关闭</button>
				</div>
			</div>
		</div>
	</div>
	...
	<script type="text/javascript"
		src="http://file.demo1.com/js/jquery-ui-1.10.2.custom.min.js"></script>
	<script type="text/javascript"
		src="http://file.demo1.com/js/jquery.ui.touch-punch.min.js"></script>
	<script type="text/javascript"
		src="http://file.demo1.com/js/jquery.slimscroll.min.js"></script>
	<script type="text/javascript"
		src="http://file.demo1.com/js/jquery.easy-pie-chart.min.js"></script>
	<script type="text/javascript"
		src="http://file.demo1.com/js/jquery.sparkline.min.js"></script>
	<!-- ace scripts -->
	<script src="http://file.demo1.com/js/ace-elements.min.js"></script>
	<script src="http://file.demo1.com/js/ace.min.js"></script>
	<!-- inline scripts related to this page -->
	<script src="http://file.demo1.com/jalert/jquery.ui.draggable.js"
		type="text/javascript"></script>
	<script src="http://file.demo1.com/jalert/jquery.alerts.js"
		type="text/javascript"></script>
</body>
<script type="text/javascript" src="http://file.demo1.com/js/xco3.js"></script>
<script type="text/javascript"
	src="http://file.demo1.com/js/jquery-xco.js"></script>
...
<script type="text/javascript"
	src="http://file.demo1.com/layer/layer.js"></script>
<script type="text/javascript"
	src="http://file.demo1.com/js/jqPaginator.js"></script>
<script type="text/javascript">
			...
			if(resources==null||undefined==resources){
				...
				for(var i=0; i<resources.length; i++){
					if(resources[i].getIntegerValue("type")==6){//日报需求附件
						...
						fjHtml += ""+resources[i].getStringValue("title")+"";
						fjHtml += '</span>';
						//<a href="javascript:void(0)" onclick="subgo()">点我</a>
						var url = resources[i].getStringValue("url");
						fjHtml += "<a href=\"javascript:void(0)\" onclick=\"look('"+url+"');\" class=\"fr\">查看</a>";
						fjHtml += '</li>';
					}	
				}

...
<body>
	<div id="main-content" class="clearfix" data-page="industry" sub-page="list">
		<div id="breadcrumbs">
			<ul class="breadcrumb">
				<li><i class="icon-home"></i> <a href="#">首页</a><span
					class="divider"><i class="icon-angle-right"></i> </span></li>
				<li></i> <a href="#">行业分类</a><span class="divider"></i>
				</span></li>
...
<script type="text/javascript">
	$(function(){
		...
		$("#add1").click(function(){
			layer.open({
				...
				area : ["600px" , "360px"],
				content: ["/view/dict/add2Industry.jsp","no"]
			});
		});
	...
	function doSubmit(){
		...
		var options ={
				url:"/tvr-system/getindustrylist.xco",
				data:data,
				success: manage
		};
	...
	function add(id){
		layer.open({
			...
			shadeClose: true, //点击遮罩关闭层
			area : ["600px" , "360px"],
			content: ["/view/dict/addIndustry.jsp?id="+id,"no"]
		});
	}
	...
	function update(id,level){
		layer.open({
			...
			shadeClose: true, //点击遮罩关闭层
			area : ["600px" , "360px"],
			content: ["/view/dict/editIndustry.jsp?id="+id+"&level="+level,"no"]
		});
	}
	...
	function del(id){
		...
		var options ={
				url:"/tvr-system/deleteIndustry.xco",
				data:data,
				success: function(data){
					if(data.getCode() != 0) {
						tvrAlert('doCallBack error:\n' + data);
					}else{
						jAlert("删除成功！", "成功提示 ", function(r) {
							window.location.href="/view/dict/industrylist.jsp";
						});
					}
				}
		};
		jConfirm("确定要删除该记录吗？", "确认框", function(r) {
			if(r){
				$.doXcoRequest(options);
			}
		});
	...
	function checkUrl(user_id){
		return '<a href="/view/customer/viewUser.jsp?user_id='+user_id+'">查看</a>';
	}
</script>
</html>
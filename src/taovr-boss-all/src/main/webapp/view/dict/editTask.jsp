					...
					<div class="row-fluid mar-t-15">
						<div class="span12">
							<form class="form-inline bord1dd form-add1">
								<div class="form-group mar-t-15" id="fname">
									<label>父级名称</label>
...
<script type="text/javascript">
	...
	//渲染单个对象
	function manage(xco){
		$("#name").val(xco.getStringValue("name"));
	...
	function queryUser2(){
		...
		xco.setIntegerValue("id", getURLparam("id"));
		var options ={
				url:"/tvr-system/getOneTask2.xco",
				data:xco,
				success: manage2
		};
		$.doXcoRequest(options);					
	...
	$(function(){
		$("#ok").click(function(){
			var data = new XCO();
			data.setIntegerValue("id",getURLparam("id"));
			...
			var options ={
					...
					success: function(data){
						if(data.getCode() != 0) {
							...
							tvrAlert("修改成功！");
							parent.window.location.href="/view/dict/tasklist.jsp";

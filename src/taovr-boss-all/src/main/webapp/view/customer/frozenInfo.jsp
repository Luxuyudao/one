		      ...
		      <div class="row-fluid mar-t-15">
		        <div class="span12">
		          <form class="form-inline bord1dd form-add1">
					...
					<div>
					<div class="form-group">
		              <label class="mar-t-15">冻结原因</label>
		              <textarea class="form-control  mar-t-15 wid310" rows="4" id="reason"></textarea>
		            </div>
		            <div class="form-group">
		            	<label class="mar-t-15"></label>
		               <label class="mar-t-15 " style="width:240px;text-align:center;color:red;">注意：冻结后，用户无法使用资金。</label>
					<div>
		          </form>
		        </div>
		      </div>
...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#stop").click(function(){
			...
			xco.setIntegerValue("user_state", 2);
			var options ={

			...
			<div class="row-fluid mar-t-15">
				<div class="span12">
					<form class="form-inline bord1dd form-add1">
						...
						<div class="form-group mar-t-15">
							<label>支付金额</label> <span id="bill_amount"></span>
						</div>
						<div class="form-group mar-t-15">
...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#select").click(function() {
			...
			var options = {
				url : "/tvr-finance/updateBillF11.xco",
				data : xco,
	...
	//关闭弹窗
	function closeWin() {
		parent.window.location.href="serviceprovidersettlement.jsp?project_sn="+project_sn;

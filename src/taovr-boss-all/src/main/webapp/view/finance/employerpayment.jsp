			...
			<div class="row-fluid mar-t-15">
				<div class="span12">
					<form class="form-inline bord1dd form-add1">
						...
						<div class="form-group mar-t-15">
							<label>付款用户</label><input id="out_account_holder" type="text"
								class="form-control wid310" placeholder=""> 
						</div>
						<div class="form-group mar-t-15">
							<label>付款账号</label> <input id="out_account" type="text"
								class="form-control wid310" placeholder="">
						</div>
						<div class="form-group mar-t-15">
							<label>付款银行</label> <input id="out_banks" type="text"
								class="form-control wid310" placeholder="">
						</div>
						<div class="form-group mar-t-15">
							<label>支付金额</label>
						...
						<div class="form-group mar-t-15">
							<label>收款用户 </label> <span>上海迪拓网络科技有限公司</span>
						</div>
						<div class="form-group mar-t-15">
							<label> 收款账号 </label><span>449468054115</span>
						</div>
						<div class="form-group mar-t-15">
							<label>收款银行</label> <span>中国银行上海市梅川路支行</span>
						</div>
						<div class="form-group mar-t-15">
							<label>备注</label>
...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#select").click(function() {
			var xco = new XCO();
			xco.setStringValue("out_account_holder", $("#out_account_holder").val());//付款用户
			xco.setStringValue("out_account", $("#out_account").val());//付款用户
			xco.setStringValue("out_banks",  $("#out_banks").val());//付款银行
			xco.setIntegerValue("out_type", 3);//账号类型
			xco.setStringValue("in_account_holder",'犀牛数码科技有限公司');//收款用户
			xco.setStringValue("in_account", '449468054115');//收款用户
			xco.setStringValue("in_banks", '中国银行上海市梅川路支行');//收款银行
			xco.setIntegerValue("in_type", 3);//账户类型
			...
			var options = {
				url : "/tvr-finance/updateBillF9.xco",
				data : xco,
	...
	//关闭弹窗
	function closeWin() {
		parent.window.location.href="employerbill.jsp?project_sn="+project_sn;

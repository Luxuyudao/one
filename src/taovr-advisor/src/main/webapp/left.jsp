	...
	<div id="sidebar">
			...
			<li class="has-sub" data-page="advisorcenter">
				...
				<ul class="submenu">
					<li class="has-sub-sub" sub-page="projectlist">
						<a href="project_list.jsp"><i class="icon-double-angle-right"></i>项目列表</a>
					</li>
					<li class="has-sub-sub" sub-page="mycase">
						<a href="my_case.jsp"><i class="icon-double-angle-right"></i>我的案例</a>
					</li>
					<li class="has-sub-sub" sub-page="submitcase">
						<a href="submit_case.jsp"><i class="icon-double-angle-right"></i>提交案例</a>
					</li>
					<li class="has-sub-sub" sub-page="addproject">
						<a href="#"><i class="icon-double-angle-right"></i>交易纠纷</a>
					</li>
					<li class="has-sub-sub" sub-page="addproject">
						<a href="#"><i class="icon-double-angle-right"></i>项目评价</a>
					</li>
					<li class="has-sub-sub" sub-page="addproject">
						<a href="#"><i class="icon-double-angle-right"></i>任务评价</a>
					</li>
					<li class="has-sub-sub" sub-page="accountsreceivable">
						<a href="accounts_receivable.jsp"><i class="icon-double-angle-right"></i>应收账款</a>
					</li>
				</ul>
			</li>
		</ul>
		<ul class="nav nav-list">
			<li class="has-sub" data-page="">
				<a href="#" class="dropdown-toggle"> 
					<i class="icon-desktop"></i> <span>账户设置</span>
					<b class="arrow icon-angle-down"></b> 
				</a>
				<ul class="submenu">
					...
					<li class="has-sub-sub" sub-page="">
						<a href="project_list.jsp"><i class="icon-double-angle-right"></i>账号绑定</a>
					</li>
					<li class="has-sub-sub" sub-page="">
						<a href="project_list.jsp"><i class="icon-double-angle-right"></i>我的级别</a>
					</li>
					<li class="has-sub-sub" sub-page="">
						<a href="project_list.jsp"><i class="icon-double-angle-right"></i>我的钱包</a>
					</li>
				</ul>
			</li>
		</ul>
		<ul class="nav nav-list">
			<li class="has-sub" data-page=""><a href="#"
				class="dropdown-toggle"> <i class="icon-desktop"></i> <span>客户服务</span>
					<b class="arrow icon-angle-down"></b> </a>
				<ul class="submenu">
					<li class="has-sub-sub" sub-page="">
						<a href="project_list.jsp"><i class="icon-double-angle-right"></i>交易纠纷</a>
					</li>
					<li class="has-sub-sub" sub-page="">
						<a href="project_list.jsp"><i class="icon-double-angle-right"></i>客户建议</a>
					</li>
				</ul>
			</li>
		</ul>

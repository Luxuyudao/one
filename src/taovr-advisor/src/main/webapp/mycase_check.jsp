...
<body>
	...
	<div id="main-content" class="clearfix" data-page="advisorcenter" sub-page="mycase">
		<div id="breadcrumbs">
			<ul class="breadcrumb">
				<li><i class="icon-home"></i> <a href="http://advisor.demo1.com/index.jsp">顾问中心</a><span class="divider"><i class="icon-angle-right"></i> </span></li>
				<li><a href="http://advisor.demo1.com/my_case.jsp">我的案例</a><span class="divider"><i class="icon-angle-right"></i> </span></li>
				<li>案例展示</li>
			</ul>
		</div>
		...
		<div id="page-content" class="clearfix">
			...
			<div class="row-fluid">
				...
				<form class="form-inline bord1dd form-add1">
					...
					<div class="form-group mar-t-15">
						<label>*项目工期</label> <span id="project_cycle"></span> <span
							id="cycle_unit_name"></span>
					</div>
					<div class="form-group mar-t-15">
						<label>*项目金额</label> <span id="budget_amount"></span><span class="mar-l-10">元</span>
					</div>

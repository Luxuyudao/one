...
<body>
		...
		<div id="main-content" class="clearfix" data-page="user" sub-page="">
			<div id="breadcrumbs">
				<ul class="breadcrumb">
					<li><i class="icon-home"></i> <a href="http://advisor.demo1.com/index.jsp">首页</a><span class="divider"><i class="icon-angle-right"></i> </span></li>			
					<li>编辑案例</li>
				</ul>
			</div>
						...
						<div class="span12">
							<div class="form-inline bord1dd form-add1">
								...
								<label class="mar-t-15">项目周期</label> <input id="project_cycle"
									...
									class="form-control mar-t-15 wid155">
...
function back(){
	window.location.href="http://advisor.demo1.com/my_case.jsp";
}

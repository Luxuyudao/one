			...
			<div id="page-content" class="clearfix">
				...
				<div class="row-fluid">
						...
						<div class="span12">
							...
							<div class="box border">
				              ...
				              <div class="form-inline bord1dd form-add1" id="project_content">
				              	<div class="form-group">
				              		<label></label>
				               	 	<span href="#" id="heyueUrl" target="_blank"></span><a href="#" class="ml15" id="downloadUrl" target="_blank">下载</a>
				                </div>
				              </div>
				            </div>
						</div>
					...
					<div class="tc mar-t-20">
						<button type="button" class="btn btn-submit" data-toggle="button" onClick="javascript :back();"><i class=" icon-undo mr10"></i>返回</button>
...
<script type="text/javascript">	
	function back(){
			...
			if(data.getCode()!=0){
				...
				if(!applies){
					...
					for ( var i = 0; i < applies.length; i++) {
						...
						str+="<div class=\"inlineBlock mb5 resultBox vm\">"+applies[i].get("remark")+"</div>";
						str+="</div>";
					}
		...
		function checksUrl(item){
			...
			if(item.getIntegerValue("task_ctrl_state")==1&&item.getIntegerValue("task_state")==40){

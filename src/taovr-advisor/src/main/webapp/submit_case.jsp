...
<body>
		...
		<div id="main-content" class="clearfix" data-page="advisorcenter" sub-page="submitcase">
			<div id="breadcrumbs">
				<ul class="breadcrumb">
					<li><i class="icon-home"></i> <a href="http://advisor.demo1.com/index.jsp">首页</a><span
						class="divider"><i class="icon-angle-right"></i> </span></li>
					<li><a href="http://advisor.demo1.com/my_case.jsp">我的案例</a><span class="divider"><i
						...
						<div class="span12">
							<div class="form-inline bord1dd form-add1">
								<div class="form-group">
									<label class="mar-t-15">项目名称</label> <input
										id="project_case_name" type="text"
										class="form-control  mar-t-15 wid310" placeholder="">
								</div>
								<div class="form-group">
									<label class="mar-t-15">项目内容</label>
									<textarea id="project_desc"
										class="form-control  mar-t-15 wid310" rows="4"></textarea>
								</div>

								<div class="form-group overhidden">
									<label class="mar-t-15">项目周期</label> <input id="project_cycle"
										type="text" class="form-control  mar-t-15 wid155"
										placeholder=""> <select id="cycle_unit_name"
										class="form-control mar-t-15 wid155" id="form-field-select-1">
								...
								<div class="form-group mar-t-15">
									<label>项目预算</label> <input id="budget_amount"
								...
								<div class="form-group">
									...
									<select id="proj_province" class="form-control mar-t-15 wid107">
									</select> 
							...
							<div class="tc mar-t-20">
								<button id="tj_btn" type="button" class="btn btn-submit" data-toggle="button">案例提交</button>
...
function back(){
	window.location.href="my_case.jsp";
}
...
$(document).ready(function(){
	...
	$("#tj_btn").click(function(){
		...
		xco.setIntegerValue("project_role",1);//项目角色project_role 1.专家  2.服务商
		...
		xco.setIntegerValue("case_audit_type",getCaseAuditType(2,1));//顾问新增案例
		...
		var options = {
			url: "/project-operate/insertProjectCaseP32.xco",
			data: xco,
			success: getInsertProject
		};
		jConfirm("确认添加该案例吗？","确认框",function(r){
			if(r){

...
<body>
  <div id="main-content" class="clearfix" data-page="projectcenter" sub-page="project_receipt">
    <div id="breadcrumbs">
      <ul class="breadcrumb">
        <li>
		<i class="icon-home"></i><a href="http://employer.demo1.com/index.jsp">项目中心</a><span class="divider"><i class="icon-angle-right"></i></span>
		</li>
		<li>项目账单</li>
      </ul>
    </div> 
	 ...
	 <script type="text/javascript">
		...
		$(document).ready(function() {
		 ...
		 function getMyProjectList(_start, _pageSize) {
			...
			xco.setStringValue("project_sn",getURLparam("project_sn"));
			if($("#a_min").val()!=''&&$("#a_min").val()!=null){
				xco.setIntegerValue("a_min", parseInt($("#a_min").val())*100);//金额范围
			}
			if($("#a_max").val()!=''&&$("#a_max").val()!=null){
				xco.setIntegerValue("a_max",  parseInt($("#a_max").val())*100);//金额范围
			}
			...
			var options = {
				url: "/tvr-finance/getBillListF13.xco",
				data: xco,

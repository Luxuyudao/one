...
function XCO() {
	...
	this.getCode = function() {
		...
		// this.dateMap.get('$$CODE').getValue();
	}
...
/*		this.ee('xxx').innerHTML = this.ee('xxx').innerHTML + xmlDoc + ":" + xmlDoc.nodeName + 
		+ ":" + xmlDoc.nodeType + 
		"<br />";*/
		//var elements = null;
	...
	/**
	 * 有问题: 模拟FORM提交 this.xcoToxml = function(url, htmlObj) { var formNew = "<form
	 * id=\"hidForm\" method=\"post\" action=\"\" style=\"display:none\">" + "<input
	 * name=\"xml\" value=\"\" id=\"con\"/>" + "<input type=\"submit\" >" + "</form>";
	 * htmlObj.append(formNew); $("#hidForm").attr("action", url);
	 * $("#hidForm").find("#con").val(this.toString()); $("#hidForm").submit(); }
	 */

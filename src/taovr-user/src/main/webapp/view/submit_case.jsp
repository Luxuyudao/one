		...
		<div id="main-content" class="clearfix" data-page="user" sub-page="">
			<div id="breadcrumbs">
				<ul class="breadcrumb">
					...
					<li></i> <a href="#">添加案例</a><span class="divider"></i> </span></li>
				</ul>
				<!--.breadcrumb-->
			</div>
			<!--#breadcrumbs-->
...
var project_role=getURLparam("project_role");
$(document).ready(function(){
	...
	$("#tj_btn").click(function(){
		...
		/* xco.setLongValue("user_id",'1');//用户ID
		xco.setStringValue("user_name",'张三');//用户名称 */
		xco.setStringValue("project_type",project_catg);//项目特征project_type
		...
		xco.setIntegerValue("audit_state",10);
...
function getInsertProject(data){
	if(data.getCode()!=0){
		...
		jAlert("申请提交成功，工作人员会在2个工作日内完成审核工作。","提示",function(r){
			window.location.href="joinapply.jsp";
		});
	}
}

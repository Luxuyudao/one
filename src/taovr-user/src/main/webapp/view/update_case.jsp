		...
		<div id="main-content" class="clearfix" data-page="user" sub-page="">
			<div id="breadcrumbs">
				<ul class="breadcrumb">
					...
					<li></i> <a href="#">修改案例</a><span class="divider"></i> </span></li>
				</ul>
				<!--.breadcrumb-->
			</div>
			<!--#breadcrumbs-->
					...
					<div class="row-fluid mar-t-15">
						<div class="span12">
							...
							<div class="tc mar-t-20">
								<button id="tj_btn" type="button" class="btn btn-submit" data-toggle="button">修改</button>
...
$(document).ready(function(){
	...
	$("#tj_btn").click(function(){
		...
		jConfirm("确认修改该案例吗？","确认框",function(r){
			if(r){
